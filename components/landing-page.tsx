...
const BorderGradientCard = ({
	...
	<div
		className={`p-px rounded-xl bg-linear-to-br from-primary/50 via-transparent to-primary/20 ${className}`}
	>
		{children}
	</div>
);
...
export default function LandingPage() {
	return (
		...
		<div className=" md:px-10 flex flex-col w-full min-h-screen bg-black text-white antialiased">
			...
			<section className="relative overflow-hidden pt-24 pb-40 md:pt-32 md:pb-48">
				<div className="container px-4 md:px-6 relative z-10 flex flex-col md:flex-row items-center gap-16">
					...
					>
						...
						<motion.h1
							className="text-6xl font-extrabold tracking-tight lg:text-7xl bg-linear-to-r from-white via-gray-100 to-primary bg-clip-text text-transparent leading-tight pb-2"
						...
						<motion.p
							...
							variants={itemVariants}
						>
							Qoldanba is the central nervous system for your university career,
							automatically syncing deadlines and class schedules.
						</motion.p>
						<motion.div
				...
				<div className="container px-4 md:px-6">
					<div className="text-center mb-16 max-w-3xl mx-auto">
						...
						<p className="text-gray-400 text-lg">
							Unlock a distraction-free workflow with core features designed
							specifically for ambitious students.
						</p>
					</div>
