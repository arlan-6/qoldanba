...
export default async function Navigation() {
  ...
  return (
    <>
      <nav className="hidden  w-full md:flex justify-center border-b border-primary/20 h-16 bg-black/40 backdrop-blur-lg sticky top-0 z-50 transition-colors duration-300">
