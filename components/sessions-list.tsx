...
const SessionsList = ({ sessions, currentTimePercent, lastSessionEndTime, isTomorrow }: SessionsListProps) => {
    return (
        <div>
            {sessions.length > 0 &&
                 (
                  <div className="mt-8">
                    ...
                    {isTomorrow ? 'Tomorrow\'s Classes':!(currentTimePercent > lastSessionEndTime)? 'Today\'s Classes':'Tomorrow\'s Classes'}
                    </h3>
